...
class MonthlyReportState extends Equatable {
  ...
  final int? avgScore; // 平均睡眠评分（月内有效报表）
...
class MonthlyReportCubit extends Cubit<MonthlyReportState> {
  MonthlyReportCubit({required BleConnectCubit connectCubit})
      : _connectCubit = connectCubit,
        super(MonthlyReportState(selectedDate: DateTime.now()));
